	...
	dimension fg(10),drg(10),dzg(10)
      dimension sg(10),ss(10),anxg(10),anyg(10),rg(10),rs(10),zg(10)
      dimension E11(10), E12(10), E21(10), E22(10)
      dimension G11(10), G12(10), G21(10), G22(10)
      dimension F11(10), F12(10), F21(10), F22(10)
c      dimension E11i(10), E12i(10), E21i(10), E22i(10)
c      dimension G11i(10), G12i(10), G21i(10), G22i(10)
c      dimension F11i(10), F12i(10), F21i(10), F22i(10)
...
c	write (*,*) 'r1=', r1
	...
	sum4 = 0.0D0
      ...
      do j=1,8
	  call Sgf_axp_caf (rg(j),zg(j),r0,z0,d,Gxx1,Gxy1,Gyx1,Gyy1)
	  call Sgf_axp_caf (rg(j),zg(j),r0,-z0,d,Gxx2,Gxy2,Gyx2,Gyy2)
	...
	y22 = sum4
      ...
      if (dabs(z0).lt.eps .or. dabs(z0-RL/2.0D0).lt.eps) then
	   y11 = 0.0D0
	   y12 = 0.0D0
	end if
...
c-------------------------------------------------
      subroutine Sgf_axp_caf (r,z,r0,z0,d,Gxx,Gxy,Gyx,Gyy)
